...
export default function HomeDashboard({
  ...
  recentListings,
  jobsOpenCount,
  latestNewsletter: _latestNewsletter,
  isLoggedIn = true,
  userStatsSlot,
  userStats,
}: Props) {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mt-4 flex flex-col items-start gap-3 sm:flex-row sm:items-center lg:justify-center">
          <Link
