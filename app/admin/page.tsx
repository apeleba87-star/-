    ...
    <div>
      ...
      <section className="mb-8">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <Link
            href="/admin/practice"
            className="block rounded-2xl border-2 border-emerald-800 bg-emerald-50 px-5 py-4 transition hover:bg-emerald-100"
          >
            <h3 className="font-black text-emerald-950">청소업 실무</h3>
            <p className="mt-1 text-sm text-emerald-900/80">칸(메뉴) 추가·수정·삭제 · 글 작성 · /practice</p>
          </Link>
          <Link
          ...
          <Link
            ...
            className="block rounded-2xl border-2 border-sky-800 bg-sky-50 px-5 py-4 transition hover:bg-sky-100"
          >
            <h3 className="font-black text-sky-950">청소장비</h3>
            <p className="mt-1 text-sm text-sky-900/80">장비 마스터 · 대표 이미지 업로드 · /equipment</p>
          </Link>
          <Link
