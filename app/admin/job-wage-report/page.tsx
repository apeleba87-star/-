  ...
  return (
    <div>
      ...
      <p className="mb-6 text-sm text-slate-600">
        전일 신규 포지션·직종 1위·공고당 대표 일당 기준 시·도별 평균과 최고 일당을 스냅샷으로 저장합니다. 자동 Cron은 설정하지 않은 경우 아래에서 수동 실행하세요. 처음 채울 때는{" "}
        <strong>최근 30일치 일괄 발행</strong>으로 과거 날짜를 한 번에 넣을 수 있습니다.
      </p>
