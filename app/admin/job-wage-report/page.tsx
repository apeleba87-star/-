  ...
  return (
    <div>
      ...
      <p className="mb-6 text-sm text-slate-600">
        <strong>30일</strong>: 어제를 말일로 한 달력 30일 구간. <strong>당일</strong>: KST 오늘 하루만 집계. 직종 1위·공고당 대표 일당 기준 시·도별 평균 등을{" "}
        <strong>리포트 1건</strong>으로 저장합니다(마지막 실행 결과만 유지). Cron을 쓰지 않을 때는 아래에서 수동 실행하세요.
      </p>
