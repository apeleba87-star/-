...
export const metadata = buildPageMetadata({
  title: "장소별 청소 가이드 | 클린아이덱스",
  description: "사무실·공장·헬스장·입주청소 등 장소별 청소 방법을 카테고리별로 확인하세요.",
  path: "/services",
});
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-teal-50/30">
      <div className="page-shell py-8 sm:py-12">
        <h1 className="text-3xl font-black text-slate-950 sm:text-4xl">장소별 청소 가이드</h1>
        <p className="mt-3 max-w-2xl text-lg leading-relaxed text-slate-600">
          사무실·상가·공장·입주 등 장소 유형별 가이드 또는 키워드 검색으로 찾아보세요.
        </p>
        ...
        <section className="mt-10 rounded-2xl border border-slate-200 bg-white p-5">
          <h2 className="font-bold text-slate-900">분류별 탐색</h2>
          <div className="mt-3 flex flex-wrap gap-2 text-sm">
            ...
            <Link href="/cases" className="rounded-lg bg-slate-100 px-3 py-1.5 font-bold text-slate-800 hover:bg-slate-200">
              사례
            </Link>
          </div>
        </section>
