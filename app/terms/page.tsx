  ...
  return (
    <>
      ...
      <section className="mt-8 space-y-6 text-[#5B6472]">
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#141824]">2. 이용자 책임</h2>
          <p className="mt-2 text-sm leading-relaxed">
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#141824]">3. 데이터/표본 고지</h2>
          <p className="mt-2 text-sm leading-relaxed">
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#141824]">4. 책임 제한</h2>
          <p className="mt-2 text-sm leading-relaxed">
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#141824]">5. 연락</h2>
          <p className="mt-2 text-sm leading-relaxed">
