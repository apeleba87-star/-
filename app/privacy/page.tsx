    ...
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <section className="mb-8">
        ...
        <ul className="mt-2 list-inside list-disc space-y-1 text-sm text-slate-700">
          ...
          <li>
            모집 안내(마감링크 등): 도급·구인 등 모집 공고 등록, 모집 안내 노출, 마감 처리 및 공고 상태
            연동
          </li>
          <li>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm leading-relaxed text-slate-700">
          ...
          제공할 수 있습니다. 모집 안내(마감링크) 이용 시 이용자가 모집 안내 노출에 동의한 공고는 모집
          안내에 노출될 수 있으며, 마감 시 연락·공고 내용은 모집 목적 범위에서 해당 안내에 반영됩니다.
          법령에 의한 경우(수사·조사 등)에는 해당 기관에 제공될 수 있습니다.
        </p>
      </section>
