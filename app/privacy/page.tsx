    ...
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <section className="mb-8">
        ...
        <ul className="mt-2 list-inside list-disc space-y-1 text-sm text-slate-700">
          ...
          <li>
            모집 안내(마감 앱 등): 도급·구인 등 모집 공고 등록, 연동 모집 안내(cleanidex) 노출, 마감 처리 및
            공고 상태 연동
          </li>
          <li>
            모집 정보의 통계·분석: 등록된 모집 정보(지역, 작업 유형, 일정, 금액 등)를 서비스 운영, 지역·업종별
            수요 분석, 통계·리포트 작성, 서비스 개선 목적으로 이용합니다. 이 과정에서 개인을 식별하지 않는
            형태로 집계·통계화할 수 있습니다.
          </li>
          <li>고객 문의·민원 처리</li>
        </ul>
      ...
      <section className="mb-8">
        ...
        <ul className="mt-2 list-inside list-disc space-y-1 text-sm text-slate-700">
          ...
          <li>선택: 닉네임, 연락처(인력 구인·현장 거래·모집 안내 이용 시)</li>
          <li>
            모집 공고 이용 시: 연락처, 공고 내용(유형, 지역, 작업 종류, 일정, 금액, 특이사항 등), 마감·연동
            노출 동의 여부 및 시각
          </li>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm leading-relaxed text-slate-700">
          서비스는 원칙적으로 이용자의 개인정보를 제3자에게 제공하지 않습니다. 다만, 인력 구인·현장 거래
          서비스에서 매칭·확정된 상대방에게 연락처 등이 제공되는 경우, 이용 동의 또는 서비스 이용약관에 따라
          제공할 수 있습니다. 모집 안내(마감 앱) 이용 시 이용자가 연동 모집 노출에 동의한 공고는 연동 모집
          안내(cleanidex)에 노출될 수 있으며, 마감 시 연락·공고 내용은 모집 목적 범위에서 연동 서비스에
          반영됩니다. 법령에 의한 경우(수사·조사 등)에는 해당 기관에 제공될 수 있습니다.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm leading-relaxed text-slate-700">
          이용자는 개인정보주체로서 언제든지 열람·정정·삭제·처리정지를 요구할 수 있으며, 서비스는 이에 대해
          지체 없이 조치합니다. 회원 탈퇴를 통해 삭제를 요청할 수 있습니다. 모집 안내 연동 노출 동의는
          서비스 설정에서 철회할 수 있으며, 철회 이후 등록하는 공고부터 연동 노출이 중단됩니다.
        </p>
      </section>
